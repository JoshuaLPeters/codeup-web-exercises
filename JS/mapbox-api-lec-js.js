...
// TODO TOGETHER: Add a marker to the map using the following coordinates
//  [-98.4916, 29.4260]. This marker will mark the Alamo on our map.
...
var homePopup = new mapboxgl.Popup()
    .setHTML("<p>Remember Home!</p>")
    .addTo(map)

marker.setPopup(homePopup);
...
// geocode("2023 Temminck Road Saint Cloud Minnesota 56301", mapboxToken).then(function(result) {
//     console.log(result);
...
reverseGeocode(coordinates,{lng: -98.4861, lat: 29.4260}, mapboxToken).then(function(results) {
    console.log(results);
});
