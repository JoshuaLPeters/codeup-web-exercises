...
var favoriteFoods = ["steak", "mashed potatoes", "wine", "asparagus"];
...
//     }
// TODO: Refactoring the instructor loop, alert "hey, I know <INSTRUCTOR NAME HERE>"
//  if you have had class with that instructor. If you have not had class with that instructor, alert "I haven't had class with <INSTRUCTOR NAME HERE> yet!"
// for (var i =0; i <instructors.length; i++){
...
//     console.log(shape);
//     console.log(index); //only use this if you need it
//     console.log(array); //only use this if you need it
// })
